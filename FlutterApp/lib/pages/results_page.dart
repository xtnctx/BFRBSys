...
class _ResultsPageState extends State<ResultsPage> {
  ...
  void handshake() async {
    if (ble != null && ble!.isConnected && !ble!.isFileTransferInProgress) {
      ...
      var fileContents = utf8.encode('xupdaterequestx-$username-last-$formattedDate-') as Uint8List;
                  ...
                  children: [
                    ...
                    IconButton(
                        onPressed: () {
                          ...
                          print('$dataFile sssssssssssssss');
                          print('$fileRead sssssssssssssss');
                          print('${dataList} sssssssssssssss');
                          for (var item in dataList) {
                            print("${item.runtimeType} ${rng.nextInt(50)}");
                          }

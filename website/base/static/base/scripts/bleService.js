...
const SERIAL_DATA_UUID = 'bf88b656-3007-4a61-86e0-769c741026c0';
...
async function connect() {
  ...
  serialDataCharacteristic = await service.getCharacteristic(SERIAL_DATA_UUID);
  await serialDataCharacteristic.startNotifications();
  serialDataCharacteristic.addEventListener('characteristicvaluechanged', onDataChanged);
